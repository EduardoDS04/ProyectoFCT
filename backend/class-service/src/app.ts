  ...
  res.json({
    ...
    endpoints: {
      ...
      classes: {
        ...
        getMyClasses: 'GET /api/classes/my-classes (monitor/admin)',
        create: 'POST /api/classes (monitor/admin)',
        update: 'PUT /api/classes/:id (monitor/admin)',
        cancel: 'PUT /api/classes/:id/cancel (monitor/admin)',
      ...
      bookings: {
        ...
        getClassBookings: 'GET /api/bookings/class/:classId (monitor/admin)',
        getAll: 'GET /api/bookings (admin only)'
      }
    }
  });
});
